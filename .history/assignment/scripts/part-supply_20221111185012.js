...
// Or alternatively:
console.log(`We filled ${boxes} boxes, and had ${parts} parts left over.`);
// Is there a preferred way to log results like this? I noticed only the first one logs the varaibles as values, and the other two combine everything into a string.